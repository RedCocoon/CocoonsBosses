data merge entity @s {\
Tags:["ccbs.tick", "ccbs.heavy_ice.circle", "ccbs.frostologer.ignore", "ccbs.new"], \
item:{id:"copper_ingot",Count:1b,tag:{CustomModelData:1440701}},\
...
scoreboard players set @s ccbs.timer 60